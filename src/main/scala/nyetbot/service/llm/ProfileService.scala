...
trait ProfileService:
    def generateReply(
        ...
        trigger: ProfileService.Trigger
    ): IO[ProfileService.GeneratedReply]

    def rewriteProfile(target: UserRef, gen: ProfileService.GeneratedReply): IO[Unit]
...
object ProfileService:
    ...
    )(using Random[IO]): ProfileService =
        new ProfileService:
