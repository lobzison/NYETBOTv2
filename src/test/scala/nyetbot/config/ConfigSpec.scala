...
class ConfigSpec extends FunSuite:
    ...
    test("application.conf exposes all nyetbot tunables with expected defaults") {
        ...
        assertEquals(root.ollama.reply.enabled, true)
        assertEquals(root.ollama.reply.profile, true)
        assertEquals(root.ollama.reply.topic, true)
        assertEquals(root.ollama.reply.chat, true)
        assertEquals(root.ollama.reply.replyTarget, true)
        assertEquals(root.ollama.reply.userTrigger, true)
        assertEquals(root.ollama.reply.task, true)
        assertEquals(root.ollama.reply.intent, true)
        assertEquals(root.ollama.reply.register, true)
        assertEquals(root.ollama.reply.date, true)
